...
<head>
  ...
  <title>EWS-PPK</title>
  <link rel="icon" href="assets/img/depan.png" type="image/icon type">
  <!-- BOOTSTRAP STYLES-->
    ...
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a href="index.php" class="navbar-brand">
          <i class="glyphicon glyphicon-send"></i>EWS-PPK</a>
      </div>
      <div class="namalevel">
        <?= $data_nama; ?>
        (<?= $data_level; ?>)
      ...
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          <li class="text-center">
            <img src="assets/img/depan.png" class="user-image img-responsive" width="40%" />
          </li>
          ...
          ?>
            ...
            <li>
              ...
              <ul class="nav nav-second-level">
                <li>
                  <a href="?page=pengadu_view">Data Petugas</a>
                </li>
                <li>
                  <a href="?page=jenis_view">Tipe Kapal</a>
                </li>
              </ul>
            </li>
            ...
            <li>
              ...
              <ul class="nav nav-second-level">
                ...
                <li>
                  <a href="?page=aduan_admin_tanggap">Di Proses</a>
                </li>
                <li>
      ...
      <div id="page-inner">
        <div class="row">
          <div class="col-md-12">
            ...
            <h4 id="marquee">
              <b> Early Warning System Pemeliharaan dan Perawatan Kapal Polisi Dipolariud Polda Lampung</b>
              <p style="margin-top: -10px;">Terhubung Melalui Whatsapp</p>
            </h4>
